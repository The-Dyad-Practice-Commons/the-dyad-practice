...
*Public commits per dyad, trailing 7d as of 2026-07-20T09:36:29+00:00. A recruitment/liveness signal — “is anyone home?” — **not** a productivity metric. A private or unreachable repo is labelled, **never** counted as 0.*
...
*16 dyads registered · 6 active in window · 93 commits (10 repos reachable). Generated by a scheduled job; the per-dyad files in `directory/` remain the source of truth.*
