...
*Public commits per dyad, trailing 7d as of 2026-08-03T10:07:24+00:00. A recruitment/liveness signal — “is anyone home?” — **not** a productivity metric. A private or unreachable repo is labelled, **never** counted as 0.*
...
*16 dyads registered · 2 active in window · 3 commits (10 repos reachable). Generated by a scheduled job; the per-dyad files in `directory/` remain the source of truth.*
