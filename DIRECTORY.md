...
*Public commits per dyad, trailing 7d as of 2026-08-17T07:18:10+00:00. A recruitment/liveness signal — “is anyone home?” — **not** a productivity metric. A private or unreachable repo is labelled, **never** counted as 0.*
...
*16 dyads registered · 1 active in window · 9 commits (9 repos reachable). Generated by a scheduled job; the per-dyad files in `directory/` remain the source of truth.*
