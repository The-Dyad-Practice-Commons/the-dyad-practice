...
*Public commits per dyad, trailing 7d as of 2026-07-13T09:48:47+00:00. A recruitment/liveness signal — “is anyone home?” — **not** a productivity metric. A private or unreachable repo is labelled, **never** counted as 0.*
...
*15 dyads registered · 7 active in window · 309 commits (9 repos reachable). Generated by a scheduled job; the per-dyad files in `directory/` remain the source of truth.*
